...
perceptual (JND) quality selection, Form XObject DPI recursion — is tracked
honestly in [`TODO-v2.md`](TODO-v2.md), and the fuller design rationale
...
Profiles: `screen` | `ebook` | `printer` (default `ebook`).
...
const { output, report } = compress_with_report(
  ...
  { image_dpi: 150, jpeg_quality: 65, signatures: "strict" }, // optional, or null
  ({ phase, done, total }) => {
